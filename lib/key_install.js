      ...
      (function(_this) {
        ...
        return function() {
          (function(__iced_k) {
            ...
            console.log(fps);
            msg = fps.length === 0 ? "key save failed; no fingerprints" : fps.length > 2 ? "keyring corruption; too many fingerprints found" : !fpeq((a = fps[0]), (b = _this._keyset.keys.code.fingerprint)) ? "fingerprint mismatch after import: " + a + " != " + b : void 0;
