...
(function() {
  var FileBundle, SoftwareUpgrade, iced, make_esc, npm, __iced_k, __iced_k_noop;
  ...
  exports.SoftwareUpgrade = SoftwareUpgrade = (function() {
    ...
    SoftwareUpgrade.prototype.fetch_package = function(cb) {
      ...
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      file = ((_ref = this.config.argv.get()) != null ? _ref[0] : void 0) || "latest-stable";
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
