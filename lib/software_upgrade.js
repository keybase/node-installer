...
(function() {
  var FileBundle, SoftwareUpgrade, constants, fs, iced, log, make_esc, npm, path, __iced_k, __iced_k_noop;
  ...
  exports.SoftwareUpgrade = SoftwareUpgrade = (function() {
    ...
    SoftwareUpgrade.prototype.fetch_package = function(cb) {
      ...
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      file = ["dist", ((_ref = this.config.argv.get()) != null ? _ref[0] : void 0) || constants.links.stable].join('/');
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
