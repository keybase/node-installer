...
(function() {
  ...
  exports.KeySetup = KeySetup = (function() {
    ...
    KeySetup.prototype.check_prepackaged_key = function(cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          _this.config.request("/" + v + "/keyset.json", esc(__iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                res = arguments[0];
        ...
        return function() {
          (function(__iced_k) {
            ...
            var _ref1;
            err = (a = typeof json !== "undefined" && json !== null ? json.version : void 0) !== v ? new Error("Version mismatch; expected " + v + " but got " + a) : ((a = typeof json !== "undefined" && json !== null ? (_ref1 = json.keys.code) != null ? _ref1.fingerprint : void 0 : void 0) == null) || !(fpeq(a, keyset.keys.code.fingerprint)) ? new Error("Fingerprint mismatch; expected " + a + " but got " + b) : null;
            return cb(err);
          });
        };
      })(this));
    ...
    KeySetup.prototype.find_latest_key = function(cb) {
      var c, comments, em, err, esc, m, master, max, out, query, uid, uids, versions, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
        ...
        return function() {
          ...
          (function(__iced_k) {
            if (versions.length === 0) {
              ...
              _this.config.set_key_version(max);
