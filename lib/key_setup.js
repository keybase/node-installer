...
(function() {
  ...
  exports.KeySetup = KeySetup = (function() {
    ...
    KeySetup.prototype.find_keyset = function(cb) {
      var esc, found, keys, v, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(_this) {
        ...
        return function() {
          (function(__iced_k) {
            ...
            log.debug("- KeySetup::find_both_keys " + found + " " + (typeof v !== "undefined" && v !== null ? '@ version ' + v : ''));
            return cb(null, found, keys);
          });
        };
      })(this));
    };
    ...
    KeySetup.prototype.run = function(cb) {
      var esc, found, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          _this.find_keyset(esc(__iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
    ...
    KeySetup.prototype.find_key = function(_arg, cb) {
      var all_keys, em, err, key, m, uid, v, version, wanted_key, wanted_v, which, ___iced_passed_deferral, __iced_deferrals, __iced_k, _i, _j, _len, _len1, _ref1, _ref2;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      for (_i = 0, _len = all_keys.length; _i < _len; _i++) {
        ...
        for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
          ...
          if ((version != null) && (v === version)) {
            ...
            wanted_v = v;
            break;
          } else if ((wanted_v == null) || v > wanted_v) {
            wanted_key = key;
            wanted_v = v;
          }
        }
      ...
      (function(_this) {
        return (function(__iced_k) {
          if (wanted_key == null) {
            return __iced_k(log.warn("No " + which + "-signing key (" + em + ") in primary GPG keychain (@ version " + wanted_v + ")"));
          } else {
            key = _this.config.master_ring().make_key({
            ...
            (function(__iced_k) {
              ...
              return __iced_k(err != null ? key = null : void 0);
            });
          }
        });
      })(this)((function(_this) {
