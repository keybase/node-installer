...
(function() {
  var BaseCommand, HelpCommand, Installer, KeyJsonCommand, Main, VersionCommand, bin, constants, fullname, getopt, iced, json_stringify_sorted, keyring, keyset, log, make_esc, os, path, run, version, __iced_k, __iced_k_noop, _ref,
  ...
  KeyJsonCommand = (function(_super) {
    ...
    KeyJsonCommand.prototype.run = function(cb) {
      if (this.config.argv.get("no-self-sig")) {
  ...
  Main = (function() {
    ...
    Main.prototype.parse_args = function(cb) {
      var err, flags;
      err = null;
      flags = ["d", "h", "v", "k", "debug", "key-json", "no-self-sig", "help", "version", "?", "skip-cleanup", "C"];
        ...
        return function() {
          ...
          keyring.init({
            ...
            get_tmp_keyring_dir: function() {
              return path.join(os.tmpdir(), "keybase-installer");
            }
          });
          return cb(null);
        };
