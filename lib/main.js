...
(function() {
  ...
  Main = (function() {
    ...
    Main.prototype.parse_args = function(cb) {
      var err, flags;
      err = null;
      flags = ["d", "h", "v", "k", "C", "?", "S", "debug", "key-json", "hash", "help", "version", "skip-cleanup", "no-https"];
