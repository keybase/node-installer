...
(function() {
  var BaseCommand, HelpCommand, Installer, Main, VersionCommand, bin, constants, fullname, getopt, gpg, iced, make_esc, run, version, __iced_k, __iced_k_noop, _ref,
  ...
  Main = (function() {
    ...
    Main.prototype.parse_args = function(cb) {
      var err, flags;
      err = null;
      flags = ["h", "v", "help", "version", "?", "skip-cleanup", "C"];
