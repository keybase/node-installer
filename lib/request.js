...
(function() {
  var ProgressBar, Request, cacert, https, iced, parse, request, single, __iced_k, __iced_k_noop;
  ...
  Request = (function() {
    ...
    Request.prototype._launch = function() {
      ...
      req = https.request(opts, (function(_this) {
        return function(res) {
          var l, _ref;
          if (_this._opts.progress && ((l = (_ref = res.headers) != null ? _ref["content-length"] : void 0) != null) && !(isNaN(l = parseInt(l, 10))) && l > 50000) {
  ...
  module.exports = request = function(opts, cb) {
    var body, err, i, lim, res, url, urls, ___iced_passed_deferral, __iced_deferrals, __iced_k, _begin, _end, _positive;
