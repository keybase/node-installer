...
(function() {
  ...
  exports.npm = npm = function(_arg, cb) {
    var args, err, name, p, ___iced_passed_deferral, __iced_deferrals, __iced_k;
    ...
    (function(_this) {
      return (function(__iced_k) {
        if (cmd != null) {
          ...
          dirname = _config.install_prefix() || process.env.NPM_INSTALL_PREFIX || path.dirname(process.execPath);
