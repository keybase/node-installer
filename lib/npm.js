        ...
        if (cmd != null) {
          ...
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              var _ref;
              if (err != null) {
                return __iced_k((_ref = err.code) === 'EACCES' || _ref === 'EPERM' ? err = new Error("Permission denied installing to " + dirname + ": try running `sudo keybase-installer`") : err = new Error("Can't write to directory " + dirname + ": " + err.code));
              } else {
                (function(__iced_k) {
                  __iced_deferrals = new iced.Deferrals(__iced_k, {
                    parent: ___iced_passed_deferral,
