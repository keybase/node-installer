        ...
        if (cmd != null) {
          ...
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              var _ref;
              if (err != null) {
                return __iced_k((_ref = e.code) === 'EACCES' || _ref === 'EPERM' ? err = new Error("Permission denied installing to " + dirname + "; you probably need sudo/root privileges (we install whenever `npm` installs to)") : err = new Error("Can't write to directory " + dirname + ": " + err.code));
              } else {
                (function(__iced_k) {
                  __iced_deferrals = new iced.Deferrals(__iced_k, {
                    parent: ___iced_passed_deferral,
