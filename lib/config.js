...
(function() {
  var Config, a_json_parse, base64u, constants, fs, fullname, iced, key_query, keyring, log, make_esc, path, request, rng, tmpdir, url_join, __iced_k, __iced_k_noop, _ref,
    __slice = [].slice;
  ...
  _ref = require('iced-error'), a_json_parse = _ref.a_json_parse, make_esc = _ref.make_esc;
  ...
  exports.Config = Config = (function() {
    ...
    Config.prototype.oneshot_verify = function(_arg, cb) {
      var err, json, raw, ring, sig, which, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      which = _arg.which, sig = _arg.sig;
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
          ...
          _this.make_oneshot_ring(which, __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                err = arguments[0];
                return ring = arguments[1];
