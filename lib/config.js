    ...
    Config.prototype.make_tmpdir = function(cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          if (_this.tmpdir == null) {
            r = base64u.encode(rng(16));
            _this.tmpdir = path.join(tmpdir(), "keybase_install_" + r);
            (function(__iced_k) {
              ...
              return __iced_k(log.info("Made temporary directory: " + _this.tmpdir));
            });
          } else {
            return __iced_k();
          }
          ...
          if (_this.tmpdir == null) {
            ...
            (function(__iced_k) {
              if (_this.argv.get("C", "skip-cleanup")) {
                return __iced_k(log.info("Preserving tmpdir " + _this.tmpdir + " as per command-line switch"));
              } else {
                log.info("cleaning up tmpdir " + _this.tmpdir);
                (function(__iced_k) {
                  __iced_deferrals = new iced.Deferrals(__iced_k, {
                    parent: ___iced_passed_deferral,
                    filename: "/Users/max/src/keybase-node-installer/src/config.iced",
