...
(function() {
  var Config, a_json_parse, base64u, chain, clean_ring, constants, fs, fullname, iced, key_query, keyring, log, make_esc, path, prng, request, tmpdir, url_join, __iced_k, __iced_k_noop, _ref, _ref1, _ref2,
    __slice = [].slice;
  ...
  _ref2 = require('./util'), clean_ring = _ref2.clean_ring, key_query = _ref2.key_query;
  ...
  exports.Config = Config = (function() {
    ...
    Config.prototype.oneshot_verify = function(_arg, cb) {
      var esc, json, raw, ring, sig, which, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      which = _arg.which, sig = _arg.sig;
      ring = null;
      clean_ring = function(cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          _this.make_oneshot_ring(which, esc(__iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
