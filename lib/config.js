...
(function() {
  var Config, a_json_parse, base64u, chain, constants, fs, fullname, iced, key_query, keyring, log, make_esc, path, prng, request, set_gpg_cmd, tmpdir, url_join, __iced_k, __iced_k_noop, _ref, _ref1, _ref2,
    __slice = [].slice;
  ...
  exports.Config = Config = (function() {
    ...
    Config.prototype.set_key_version = function(v) {
      if (this._key_version !== v) {
        log.info("Using key version v" + v);
      }
      return this._key_version = v;
    };

    Config.prototype.set_alt_cmd = function() {
      if ((this._alt_cmd = this.argv.get("c", "cmd"))) {
        return set_gpg_cmd(this._alt_cmd);
      }
    };

    Config.prototype.get_alt_cmd = function() {
      return this._alt_cmd;
    };
