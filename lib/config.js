...
(function() {
  ...
  exports.Config = Config = (function() {
    ...
    Config.prototype.request = function(u, cb) {
      ...
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      url = u.match("^https?://") ? this.make_url(u) : u;
      opts = {
        url: url,
        headers: {
      ...
      (function(_this) {
        ...
        return function() {
          log.info(" - Fetched -> " + (typeof res !== "undefined" && res !== null ? res.statusCode : void 0));
    ...
    Config.prototype.oneshot_verify = function(_arg, cb) {
      var err, json, query, sig, which, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          keyring.master_ring().oneshot_verify({
            query: query,
            sig: sig,
            single: true
