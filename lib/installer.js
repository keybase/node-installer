...
(function() {
  var BaseCommand, BufferOutStream, FileBundle, GPG, Installer, constants, fs, fullname, iced, id64, key, make_esc, npm, path, request, rng, signer_id_email, tmpdir, to_base64x, url_join, __iced_k, __iced_k_noop, _ref, _ref1,
    __slice = [].slice,
        ...
        return function() {
          if (typeof err === "undefined" || err === null) {
            ...
            if ((count_lines(data, /Signature made/) !== 1) || (count_lines(data, /using RSA key/) !== 1) || (count_lines(data, /Good signature from/) !== 1)) {
              ...
              err = new Error("Didn't get a signature with short_id " + id64);
