...
(function() {
  var BaseCommand, BufferOutStream, FileBundle, GPG, Installer, SetupKeyRunner, constants, fs, fullname, iced, id64, key, make_esc, npm, path, request, rng, signer_id_email, tmpdir, to_base64x, __iced_k, __iced_k_noop, _ref, _ref1,
  ...
  exports.Installer = Installer = (function(_super) {
    ...
    Installer.prototype.setup_key = function(cb) {
      ...
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      sk = new SetupKeyRunner(this.config);
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
