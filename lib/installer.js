...
(function() {
  var BaseCommand, BufferOutStream, FileBundle, Installer, assert_exactly_one, constants, fs, fullname, gpg, iced, id32, id64, key, make_esc, npm, path, request, rng, signer_id_email, tmpdir, to_base64x, url_join, __iced_k, __iced_k_noop, _ref, _ref1,
    __slice = [].slice,
  ...
  exports.Installer = Installer = (function(_super) {
    ...
    Installer.prototype.run = function(cb) {
      var e2, err, esc, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      esc = make_esc(cb, "Installer::run");
      (function(_this) {
            ...
            (function(__iced_k) {
              ...
              (function(__iced_k) {
                ...
                (function(__iced_k) {
                  ...
                  (function(__iced_k) {
                    if ((typeof err === "undefined" || err === null) && !_this.argv.get("C", "skip-cleanup")) {
                      (function(__iced_k) {
                        __iced_deferrals = new iced.Deferrals(__iced_k, {
                          parent: ___iced_passed_deferral,
                          filename: "/Users/max/src/keybase-node-installer/src/installer.iced",
