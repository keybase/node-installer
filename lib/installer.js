...
(function() {
  var BaseCommand, FileBundle, Installer, assert_exactly_one, constants, fs, fullname, gpg, iced, key, make_esc, path, request, rng, short_id, tmpdir, url_join, __iced_k, __iced_k_noop, _ref, _ref1,
    __slice = [].slice,
