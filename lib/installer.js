...
(function() {
  var BaseCommand, BufferOutStream, FileBundle, GPG, Installer, constants, fs, fullname, iced, id32, id64, key, make_esc, npm, path, request, rng, signer_id_email, tmpdir, to_base64x, url_join, __iced_k, __iced_k_noop, _ref, _ref1,
    __slice = [].slice,
      ...
      (function(_this) {
        ...
        return function() {
          (function(__iced_k) {
            ...
            _this.gpg.assert_exactly_one(id32, esc(__iced_deferrals.defer({
              lineno: 72
            })));
            __iced_deferrals._fulfill();
          })(function() {
