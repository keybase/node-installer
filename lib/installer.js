...
(function() {
  var BaseCommand, BufferOutStream, FileBundle, Installer, assert_exactly_one, constants, fs, fullname, gpg, iced, id32, id64, key, make_esc, npm, path, request, rng, signer_id_email, tmpdir, url_join, __iced_k, __iced_k_noop, _ref, _ref1,
    __slice = [].slice,
