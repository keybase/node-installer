...
(function() {
  var BaseCommand, BufferOutStream, FileBundle, GPG, GetIndex, Installer, KeySetup, base64u, constants, fs, fullname, iced, id64, key, keyring, log, make_esc, npm, path, request, rng, signer_id_email, tmpdir, __iced_k, __iced_k_noop, _ref, _ref1,
  ...
  exports.Installer = Installer = (function(_super) {
    ...
    Installer.prototype.make_tmpdir = function(cb) {
          ...
          if (_this.tmpdir == null) {
            ...
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                parent: ___iced_passed_deferral,
                filename: "/Users/max/src/keybase-node-installer/src/installer.iced",
                funcname: "Installer.make_tmpdir"
              });
    ...
    Installer.prototype.run = function(cb) {
      ...
      (function(_this) {
        ...
        return function() {
          (function(__iced_k) {
            if (!_this.config.argv.get("C", "skip-cleanup")) {
              (function(__iced_k) {
                __iced_deferrals = new iced.Deferrals(__iced_k, {
                  parent: ___iced_passed_deferral,
                  filename: "/Users/max/src/keybase-node-installer/src/installer.iced",
