...
(function() {
  var BaseCommand, BufferOutStream, FileBundle, Installer, assert_exactly_one, constants, fs, fullname, gpg, iced, key, make_esc, path, request, rng, short_id, tmpdir, url_join, __iced_k, __iced_k_noop, _ref, _ref1,
    __slice = [].slice,
  ...
  exports.Installer = Installer = (function(_super) {
    ...
    Installer.prototype.fetch_package = function(cb) {
      var body, err, file, opts, prefix, res, sc, url, ___iced_passed_deferral, __iced_deferrals, __iced_k, _ref2;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      err = null;
    ...
    Installer.prototype.verify_signature = function(cb) {
      var args, data, err, out, stderr, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
